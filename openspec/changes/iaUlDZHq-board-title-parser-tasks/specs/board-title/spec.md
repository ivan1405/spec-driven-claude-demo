...
The application must display "Parser Tasks Board" as its product name in all
...
WHEN the page loads  
THEN the browser tab title reads "Spec Workflow · Parser Tasks Board"

#### Scenario: Header shows updated brand name

GIVEN the app is rendered  
WHEN the user views the header  
THEN the brand-name element contains the text "Parser Tasks Board"
